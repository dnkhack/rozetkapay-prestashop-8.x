...
include_once __dir__ . '/classes/php_sdk_simple.php';
include_once __dir__ . '/classes/phpqrcode.php';
...
class RozetkaPay extends PaymentModule {
    ...
    const UP_commit = "36975d94df5f01159d5627a1211b4aa4304fd46b";
    const UP_CMS_name = "pencart-3.x"; 
    const UP_owner = "rozetkapay";
    ...
    public $ps_versions_compliancy = array('min' => '1.7.6.0', 'max' => _PS_VERSION_);
    ...
    public $author_uri = "https://rozetkapay.com/";
    ...
    public function __construct() {
        ...
        $this->displayName = $this->languages['text_displayName'];
        $this->description = $this->languages['text_description'];
        $this->confirmUninstall = $this->languages['text_confirmUninstall'];
    ...
    public function loadLanguagesA1() {
        ...
        $this->langCode = $this->context->language->iso_code;
    ...
    public function hookPaymentOptions($params)
    {
        ...
        if(Configuration::get('ROZETKAPAY_VIEW_ICON_STATUS') == "1"){
    ...
    public function payRefund() {
        ...
        if (empty($this->error)) {
            ...
            $dataPay = new \RozetkaPay\Model\PaymentRequest();
    ...
    public function getTitle() {
        ...
        if (Configuration::get('ROZETKAPAY_VIEW_TITLE_DEFAULT') == "1") {
            $title = $this->languages['text_catalog_title'];
        } else {
