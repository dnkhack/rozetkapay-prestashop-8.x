...
<ul class="nav nav-tabs" role="tablist">    
    <li class="active"><a href="#general" role="tab" data-toggle="tab">{$text_tab_general_title}</a></li>
    <li><a href="#order_status" role="tab" data-toggle="tab">{$text_tab_order_status_title}</a></li>
    <li><a href="#view" role="tab" data-toggle="tab">{$text_tab_view_title}</a></li>
    <li><a href="#sandbox" role="tab" data-toggle="tab">{$text_tab_sandbox_title}</a></li>
    <li><a href="#system_info" role="tab" data-toggle="tab">{$text_tab_system_info_title}</a></li>
</ul>
<form class="defaultForm form-horizontal" action="{$url_submit}" method="post" enctype="multipart/form-data" novalidate="">
    ...
    <div class="tab-content">
        <div class="tab-pane active" id="general">
            <div class="panel">
                ...
                <div class="row"> 
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">{$text_tab_general_send_info_customer_status}</label>
                        <div class="col-sm-2">
                            <span class="switch prestashop-switch fixed-width-lg">
                                ...
                                <label for="send_info_customer_status_on">{$_yes_}</label>
                                ...
                                <label for="send_info_customer_status_off">{$_no_}</label>
                                <a class="slide-button btn"></a>
                            </span>
                        </div>

                        <label class="col-sm-2 control-label">{$text_tab_general_send_info_products_status}</label>
                        <div class="col-sm-2">
                            <span class="switch prestashop-switch fixed-width-lg">
                                ...
                                <label for="send_info_product_status_on">{$_yes_}</label>
                                ...
                                <label for="send_info_product_status_off">{$_no_}</label>
                                <a class="slide-button btn"></a>
                            </span>
                        </div>
                    </div>
        ...
        <div class="tab-pane" id="order_status">
            <div class="panel">
                ...
                <div class="row">    
                    <div class="form-group">
                        <label class="control-label col-lg-3">{$text_tab_order_status_init}</label>
                        <div class="col-lg-3">
                    ...
                    <div class="form-group">
                        <label class="control-label col-lg-3">{$text_tab_order_status_pending}</label>
                        <div class="col-lg-3">
                    ...
                    <div class="form-group">
                        <label class="control-label col-lg-3">{$text_tab_order_status_success}</label>
                        <div class="col-lg-3">
                    ...
                    <div class="form-group">
                        <label class="control-label col-lg-3">{$text_tab_order_status_failure}</label>
                        <div class="col-lg-3">
        ...
        <div class="tab-pane" id="view">
            <div class="panel">
                <div class="row"> 
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">                            
                            <span class="switch prestashop-switch fixed-width-lg">
                                ...
                                <label for="view_title_default_on">{$_yes_}</label>
                                ...
                                <label for="view_title_default_off">{$_no_}</label>                                
                                <a class="slide-button btn"></a>
                            </span>
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-status">{$text_tab_view_title_text}</label>
                        <div class="col-sm-4">
        ...
        <div class="tab-pane" id="sandbox">
            <div class="panel">
                ...
                <div class="row"> 
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-status">{$text_tab_sandbox_test_cards}</label>
                        <div class="col-sm-10">
                        ...
                        <div class="panel-heading">
                            ...
                            <div class="pull-right">
                                <a id="log_refresh" onclick="nt_log_refresh()" data-toggle="tooltip" class="btn btn-warning">
                                    <i class="fa fa-refresh"></i> {$text_tab_sandbox_button_log_refresh}
                                </a>
                                <a href="{$urlLogDownload}" target="_blank" data-toggle="tooltip" class="btn btn-primary">
                                    <i class="fa fa-download"></i>{$text_tab_sandbox_button_log_download}
                                </a>
                                <a href="{$urlLogClear}" data-toggle="tooltip" class="btn btn-danger">
                                    <i class="fa fa-eraser"></i>{$text_tab_sandbox_button_log_clear}
                                </a>
                            </div>
                        </div>
    ...
    <button type="submit" value="1" id="submitSetting" name="submitSetting" class="btn btn-default pull-right">
        <i class="process-icon-save"></i> {$text_button_save}
    </button>
</form>
<script>
