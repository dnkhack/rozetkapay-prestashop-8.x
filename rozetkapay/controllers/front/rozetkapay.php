...
class RozetkaPayRozetkaPayModuleFrontController extends ModuleFrontController {
    ...
    public function initContent() {
        ...
        $this->context->smarty->assign(array(
            ...
            'pageType' => 'comfire',
            'text_payment_execution_h3' => $this->languages['text_catalog_payment_execution_h3'],
        ));
    ...
    public function creatPay() {
        ...
        if($isPayQRcode){
            $this->context->smarty->assign('urlGenQrCode', Context::getContext()->link->getModuleLink('rozetkapay', 'rozetkapay', 
                ['action' => 'genQrCode', 'id_order' => $idOrder]));
        ...
        $this->context->smarty->assign(array(
            'pageType' => '',
            'text_catalog_button_pay' => $this->module->gL('text_catalog_button_pay'),
            'text_payment_execution_h3' => $this->module->gL('text_catalog_payment_execution_h3'),
        ));
